...
|     | ,实验步骤              |      |
| 1.4 | 4.1 数据预处理          | 10   |
| 1.4 | <sub>4.2</sub> 思考题 | . 22 |
| 1.4 | 4.3 数据预处理 - 分类数据   | 23   |
| 1.5 | 5 实验小结             | 30   |
...
开启此功能后,可创建一个带有 Git 存储库的 Notebook 实例,系统将自 动从 Github 同步代码库。详细配置说明请参[见创建带有](https://support.huaweicloud.com/engineers-modelarts/modelarts_23_0279.html) Git 存储库的
...
[Notebook](https://support.huaweicloud.com/engineers-modelarts/modelarts_23_0279.html) 实例。
...
|     | Арр                                                             | Rating | Reviews | Size | Installs   | Туре | Price | Content<br>Rating | Genres | Category_ART_AND_DESIGN Category_PERSONAL | LIZATION |
|-----|-----------------------------------------------------------------|--------|---------|------|------------|------|-------|-------------------|--------|-------------------------------------------|----------|
...
|   | Арр                                                             | Rating | Reviews | Size | Installs   | Туре | Price | Content<br>Rating | Genres | Category_ART_AND_DESIGN | <br>Category_PERSONALIZATION |
|---|-----------------------------------------------------------------|--------|---------|------|------------|------|-------|-------------------|--------|-------------------------|------------------------------|
| 0 | Photo<br>Editor &<br>Candy<br>Camera &<br>Grid &<br>ScrapBook   | 4.1    | 159     | 19.0 | 10000.0    | 1    | 0.0   | 1                 | 3      | 1                       | <br>(                        |
| 1 | Coloring<br>book<br>moana                                       | 3.9    | 967     | 14.0 | 500000.0   | 1    | 0.0   | 1                 | 3      | 1                       | <br>(                        |
| 2 | U<br>Launcher<br>Lite –<br>FREE Live<br>Cool<br>Themes,<br>Hide | 4.7    | 87510   | 8.7  | 5000000.0  | 1    | 0.0   | 1                 | 3      | 1                       | <br>(                        |
| 3 | Sketch -<br>Draw &<br>Paint                                     | 4.5    | 215644  | 25.0 | 50000000.0 | 1    | 0.0   | 4                 | 3      | 1                       | <br>(                        |
